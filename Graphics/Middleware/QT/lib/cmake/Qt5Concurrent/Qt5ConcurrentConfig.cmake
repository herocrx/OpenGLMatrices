...
set(Qt5Concurrent_VERSION_MAJOR 5)
set(Qt5Concurrent_VERSION_MINOR 0)
set(Qt5Concurrent_VERSION_PATCH 2)
set(Qt5Concurrent_VERSION_STRING 5.0.2)
...
macro(_populate_Concurrent_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::Concurrent PROPERTIES
        ...
        "IMPORTED_LOCATION_${Configuration}" "${_qt5Concurrent_install_prefix}/lib/${LIB_LOCATION}"
...
if (NOT TARGET Qt5::Concurrent)
    ...
    set(Qt5Concurrent_INCLUDE_DIRS "${_qt5Concurrent_install_prefix}/include/QtConcurrent")
    set(Qt5Concurrent_PRIVATE_INCLUDE_DIRS
        "${_qt5Concurrent_install_prefix}/include/QtConcurrent/${Qt5Concurrent_VERSION_STRING}"
        "${_qt5Concurrent_install_prefix}/include/QtConcurrent/${Qt5Concurrent_VERSION_STRING}/QtConcurrent"
    )
    ...
    foreach(_module_dep ${_Qt5Concurrent_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ...
                PATHS "${_qt5Concurrent_install_prefix}" NO_DEFAULT_PATH
            )
        endif()
    ...
    _populate_Concurrent_target_properties(RELEASE "libQt5Concurrent.so.5.0.2" "" )
