...
set(Qt5Multimedia_VERSION_MAJOR 5)
set(Qt5Multimedia_VERSION_MINOR 0)
set(Qt5Multimedia_VERSION_PATCH 2)
set(Qt5Multimedia_VERSION_STRING 5.0.2)
...
macro(_populate_Multimedia_target_properties Configuration LIB_LOCATION IMPLIB_LOCATION)
    ...
    set_target_properties(Qt5::Multimedia PROPERTIES
        ...
        "IMPORTED_LOCATION_${Configuration}" "${_qt5Multimedia_install_prefix}/lib/${LIB_LOCATION}"
...
if (NOT TARGET Qt5::Multimedia)
    ...
    set(Qt5Multimedia_INCLUDE_DIRS "${_qt5Multimedia_install_prefix}/include/QtMultimedia")
    ...
    foreach(_module_dep ${_Qt5Multimedia_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                ...
                PATHS "${_qt5Multimedia_install_prefix}" NO_DEFAULT_PATH
            )
        endif()
    ...
    _populate_Multimedia_target_properties(RELEASE "libQt5Multimedia.so.5.0.2" "" )
