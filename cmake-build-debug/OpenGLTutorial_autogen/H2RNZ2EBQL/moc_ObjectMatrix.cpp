...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_ObjectMatrix_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 26, 0)
    ...
    "ObjectMatrix\0updateMatrix\0\0"
};
...
void ObjectMatrix::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ObjectMatrix *_t = static_cast<ObjectMatrix *>(_o);
        switch (_id) {
...
const QMetaObject ObjectMatrix::staticMetaObject = {
    { &QGridLayout::staticMetaObject, qt_meta_stringdata_ObjectMatrix.data,
      qt_meta_data_ObjectMatrix,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ObjectMatrix.stringdata))
        return static_cast<void*>(const_cast< ObjectMatrix*>(this));
