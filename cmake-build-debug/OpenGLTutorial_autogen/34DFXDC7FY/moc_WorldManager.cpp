...
#include "../../../OpenglWindow/World/WorldManager.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_WorldManager_t, stringdata) + ofs \
...
const QMetaObject WorldManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WorldManager.data,
      qt_meta_data_WorldManager,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WorldManager.stringdata))
